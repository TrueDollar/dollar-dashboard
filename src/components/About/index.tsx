...
function About() {
  return <div>
    ...
    <div>
      <Text>
        Token: <a href="https://etherscan.io/token/0x4846239fdf4d4c1aeb26729fa064b0205aca90e1" target="_blank">https://etherscan.io/token/0x4846239fdf4d4c1aeb26729fa064b0205aca90e1</a>
      </Text>
      <Text>
      ...
      <Text>
        Dextools: <a href="https://www.dextools.io/app/uniswap/pair-explorer/0x55b0c2eee5d48af6d2a65507319d20453e9f97b6" target="_blank">https://www.dextools.io/app/uniswap/pair-explorer/0x55b0c2eee5d48af6d2a65507319d20453e9f97b6</a>
      </Text>
    </div>
    <div>
      ...
      <ul style={{ marginLeft: 40 }}>
        ...
        <TextBasic>Method: <a href="https://uniswap.org/docs/v2/core-concepts/oracles/" target="_blank">Uniswap V2 Time Weighted Average Price (TWAP)</a></TextBasic>
    ...
    <div>
      ...
      <Text>Our plan is to pre-mine only a small number of tokens (half amount of ESD and DSD premined) and they will be placed in lock for DAO rewards and also will be used for the initial liquidity for the USDC/TSD paid. These tokens are locked up hence there are no hidden supplies!</Text>
    </div>
    <div>
      <TitleSub>Why TSD?</TitleSub>
      <Text>We believe in the future of algorithm stablecoins like $ESD, $DSD. We also see the problem that long epoch time can lead to unstable value of the tokens. This is our experiment to explorer whether fast epoch time can adjust the price better or not. So please DYOR before investing in our project.</Text>
    </div>
  </div>
}
